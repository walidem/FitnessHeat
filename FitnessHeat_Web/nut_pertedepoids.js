document.addEventListener('DOMContentLoaded', function() {
    loadWeightLossNutritionPrograms();
});

function loadWeightLossNutritionPrograms() {
    fetch('http://localhost:3000/api/programmes')
        ...
        .then(programs => {
            ...
            programs.forEach(program => {
                if (program.Type === 'Nutrition' && program.ID_Categorie === mapCategoryNameToId('perte_de_poids')) {
